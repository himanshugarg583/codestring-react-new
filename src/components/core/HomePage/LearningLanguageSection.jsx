  ...
  return (
    <div>
        <div className="text-4xl font-semibold text-center my-10">
            ...
            <HighlightText text={"learning any language, all in one place."} />
            <div className="text-center text-richblack-700 font-medium lg:w-[75%] mx-auto leading-6 text-base mt-3">
              Spin makes learning multiple languages easy with realistic voice-overs in 20+ languages, 
              progress tracking, personalized schedules, and more.
            </div>
